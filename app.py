...
def handle_message(event):
    ...
    if text_message.text == "終了":
        ...
        os.remove(f"LineBot-LateBloomer/user_profiele/user_profiele.text")
        os.remove(f"LineBot-LateBloomer/interview/interview_log.text")
...
def handle_message(event):
    ...
    os.remove(f"LineBot-LateBloomer/lineoudio/{message_id}.m4a")
...
def STT_whisper(message_id):
    ...
    with open(f"./LineBot-LateBloomer/lineoudio/{message_id}.m4a", 'wb') as fd:
        fd.write(message_content.content)
        audio_path = fd.name
    with open(f"./LineBot-LateBloomer/lineoudio/{message_id}.m4a", "rb") as fd:
...
def profiele_file_write(file_content):
    with open(f"./LineBot-LateBloomer/user_profiele/user_profiele.text", 'wb') as f:
        f.write(file_content.encode('utf-8'))

def profiele_file_read():
    with open(f"./LineBot-LateBloomer/user_profiele/user_profiele.text", 'rb') as f:
        profiele = f.read()
    return profiele

def interview_file_write(file_content):
    with open(f"./LineBot-LateBloomer/interview/interview_log.text", 'wb') as f:
        f.write(file_content.encode('utf-8'))

def interview_file_read():
    with open(f"./LineBot-LateBloomer/interview/interview_log.text", 'rb') as f:
